(function ($) {
   ...
   $("[data-appear-animation]").each(function() {
    ...
    Active Hover
    -------------------------------------*/ 
    $( ".active-onhover .pbmit-miconheading-style-7:nth-child(2)" ).addClass('pbmit-mihbox-hover-active');
    
      $( ".active-onhover .pbmit-miconheading-style-7" ).mouseover(function() {
        var main_row = $( this ).closest( '.active-onhover' );
        $('.pbmit-miconheading-style-7', main_row).removeClass('pbmit-mihbox-hover-active'); 
        $(this).addClass('pbmit-mihbox-hover-active');
      }).mouseout(function() {
        var main_row = $( this ).closest( '.active-onhover' );
        $('.pbmit-miconheading-style-7', main_row).removeClass('pbmit-mihbox-hover-active');
        $('.pbmit-miconheading-style-7:nth-child(2)', main_row).addClass('pbmit-mihbox-hover-active');
